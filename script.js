...
function totalPerPerson() {
    ...
    if (isNaN(tipTotal) || tipTotal === Infinity) {
        ...
        tipAmount.textContent = "R" + tipTotal.toFixed(2).toString();
        total.textContent = "R" + grandTotal.toFixed(2).toString();
    }
}
// ! Reset Button
...
resetBTN.addEventListener("click", () => {
    ...
    tipAmount.textContent = "R0.00"; // sets the tip amount to 0
    total.textContent = "R0.00"; // sets the total amount to 0
})
